...
The complete mod source is in [`src/dllmain.cpp`](src/dllmain.cpp) and [`src/helmet_render_fit.cpp`](src/helmet_render_fit.cpp), with reproducible build instructions in [`docs/BUILDING.md`](docs/BUILDING.md).
